...
---
Notes:
* Pipeline for Qiime2, see Qiime2 tutorials for more options and better descriptions (https://docs.qiime2.org/2018.11/)
...
* Use https://view.qiime2.org to view .qzv files and select values for 'm' and 'n' accordingly.
...
Make metadata.tsv (https://docs.qiime2.org/2018.2/tutorials/metadata/)
...
---
###### Merge Denoised Datasets (if necessary)
...
* "Emperor" output files create maneuverable MDS plots in qiime2.view (https://view.qiime2.org/)
